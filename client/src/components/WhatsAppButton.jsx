...
const WhatsAppButton = ({ productName = "", productPrice = "" }) => {
    const phoneNumber = "919756769613"; // Store phone number

    const getMessage = () => {
        if (productName && productPrice) {
            return `Hi! I'm interested in ordering:\n\n*${productName}*\nPrice: ₹${productPrice}\n\nPlease confirm availability.`;
        }
        return "Hi! I'm interested in ordering from Pahadi Bazaar. Please help me with my order.";
    };
