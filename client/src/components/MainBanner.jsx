  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-50 via-green-100 to-teal-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-48 h-48 bg-emerald-200/40 rounded-full blur-3xl animate-pulse delay-700"></div>
        <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-teal-200/30 rounded-full blur-xl animate-bounce"></div>
        ...
        <div className="flex-1 relative mt-10 md:mt-0 z-10">
          <div className="relative w-full max-w-lg mx-auto">
            ...
            <div className="relative">
              {/* Decorative ring */}
              <div className="absolute inset-0 rounded-full border-4 border-dashed border-green-200 animate-spin-slow" style={{ animationDuration: '20s' }}></div>
            ...
            <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg p-3 animate-bounce" style={{ animationDuration: '3.5s' }}>
              <div className="flex items-center gap-2">
                <span className="text-2xl">🍎</span>
                <div>
            ...
            <div className="absolute top-1/2 -right-8 bg-gradient-to-r from-yellow-400 to-orange-400 text-white rounded-full px-4 py-2 shadow-lg animate-pulse">
