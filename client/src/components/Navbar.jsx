...
const Navbar = () => {
  const { darkMode, toggleTheme, navigate } = useAppContext();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/bookings"
              className="md:hidden p-2 rounded-lg bg-indigo-100 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-400"
            >
